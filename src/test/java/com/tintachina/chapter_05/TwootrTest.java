...
import static com.tintachina.chapter_05.FollowStatus.ALREADY_FOLLOWING;
import static com.tintachina.chapter_05.FollowStatus.SUCCESS;
import static com.tintachina.chapter_05.TestData.TWOOT;
import static com.tintachina.chapter_05.TestData.twootAt;
...
public class TwootrTest {
  ...
  public void setUp() {
    ...
    assertEquals(RegistrationStatus.SUCCESS,
  ...
  public void shouldNotReceiveTwootsAfterLogoff() {
    ...
    verify(receiverEndPoint, never()).onTwoot(
        new Twoot(id, TestData.OTHER_USER_ID, TWOOT, POSITION_1));
  }
